<x-layout bodyClass="g-sidenav-show bg-gray-200">
    ...
    <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage='Create Offer'></x-navbars.navs.auth>
        <!-- End Navbar -->
                    ...
                    <div class="card-body p-3">
                        ...
                        <form id="createOfferForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    <label class="form-label">{{ __('Retail Price') }}</label>
                    ...
                    submitHandler: function(form) {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                Notiflix.Notify.success(response.message || 'Offer created successfully!');
                                form.reset();
                                setTimeout(function() {
