<x-layout bodyClass="g-sidenav-show bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        <x-navbars.navs.auth titlePage="{{ __('Add Attribute') }}"></x-navbars.navs.auth>
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">{{ __('Create Attribute Definition') }}</h6>
                            </div>
                        </div>
                            ...
                            <form action="{{ route('attributes.store') }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="name_en" class="form-control border border-2 p-2" required>
                                        @error('name_en') <span class="text-danger text-xs">{{ $message }}</span> @enderror
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">{{ __('Name (Arabic)') }}</label>
                                        <input type="text" name="name_ar" class="form-control border border-2 p-2" required>
                                ...
                                <div id="values-wrapper">
                                    ...
                                    <div class="row value-row mb-2">
                                        <div class="col-md-5">
                                            <label class="form-label text-xs">{{ __('Value (English)') }}</label>
                                            <input type="text" name="values[0][value_en]" class="form-control border border-2 p-2" required>
                                        </div>
                                        <div class="col-md-5">
                                            <label class="form-label text-xs">{{ __('Value (Arabic)') }}</label>
                                            <input type="text" name="values[0][value_ar]" class="form-control border border-2 p-2" required>
                                        </div>
                                        <div class="col-md-2 d-flex align-items-end">
                                            <button type="button" class="btn btn-sm btn-outline-danger remove-row mb-0" style="visibility: hidden;">
                                ...
                                <div class="text-end mt-4">
                                    ...
                                    <button type="submit" class="btn bg-gradient-dark ms-2">{{ __('Save Attribute') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
